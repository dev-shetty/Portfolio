...
export const travels: TravelEntry[] = [
  ...
  },
  {
    ...
    photos: [
      ...
      { url: "mumbai/csmt-dome-ceiling.webp", caption: "BMC Golden Dome Ceiling" },
      { url: "mumbai/csmt-gothic-stained-glass.webp", caption: "BMC Gothic Stained Glass" },
      { url: "mumbai/csmt-grand-staircase.webp", caption: "BMC Grand Staircase" },
      { url: "mumbai/csmt-statue-panoramic.webp", caption: "Mumbai Panoramic View from BMC Building" },
      ...
      { url: "mumbai/elephanta-caves-window.webp", caption: "Elephanta Caves — Pillar through a Cavity in the Wall" },
      { url: "mumbai/elephanta-caves-doorway.webp", caption: "Elephanta Caves — Cave Cavity" },
      { url: "mumbai/atal-setu-bridge-view.webp", caption: "Atal Setu Bridge and Elephanta Jetty from Elephanta Hills" },
      ...
      { url: "mumbai/m2m-ferry-mumbai-skyline.webp", caption: "M2M Ferry against the Mumbai Skyline" },
  ...
  },
  {
    ...
    photos: [
      ...
      { url: "rishikesh/parmarth-teerth-ganga-aarti.webp", caption: "Ganga Aarti at Parmarth Niketan" },
      ...
      { url: "rishikesh/banks-of-ganga.webp", caption: "Rushing Rain, Rusty Railings, Raging River, Rugged Mountains and Restless Roads at Rishikesh" },
  ...
  },
  {
    ...
    photos: [
      { url: "vrindavan/prem-mandir-devotees.webp", caption: "Prem Mandir with Devotees" },
      { url: "vrindavan/prem-mandir-krishna-leela-panels.webp", caption: "Prem Mandir Krishna Leela Panels" },
      { url: "vrindavan/prem-mandir.webp", caption: "Prem Mandir" },
      { url: "vrindavan/painted-lane-murals.webp", caption: "Painted Lane Murals" },
  ...
  },
  {
    ...
    photos: [
      ...
      { url: "mangalore/beach-sunset.webp", caption: "Thannirbhavi Beach Sunset" },
      ...
      { url: "mangalore/mariyamma-temple-entrance.webp", caption: "Bolar Marigudi Temple" },
      { url: "mangalore/mangaladevi-temple-interior.webp", caption: "Mangaladevi Temple" },
  ...
  },
  {
    ...
    photos: [
      { url: "puttur/illuminated-temple-chariot-night.webp", caption: "Puttur Brahmarathotsava (Grand Chariot Festival)" },
      { url: "puttur/temple-festival-procession-flags.webp", caption: "Temple Festival Procession" },
      { url: "puttur/deity-idol-flower-garland-procession.webp", caption: "Puttur Mahalingeshwara Idol with Flower Garland Procession" },
    ],
  ...
  },
  {
    ...
    photos: [
      { url: "penang/city-skyline-observation-deck.webp", caption: "City Skyline from Komtar Tower, Tallest Building in Penang" },
      { url: "penang/kids-on-bicycle-street-art.webp", caption: "Kids on Bicycle Street Art" },
      { url: "penang/beach-hills-view.webp", caption: "Batu Ferringhi Beach" },
    ],
    tags: ["culture", "nature"],
  },
  {
