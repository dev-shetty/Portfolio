...
description: "Selfhosting my slides on my VPS using nginx, with a detailed guide on how to setup a subdomain and nginx to serve your static files."
date: 2025-11-30
...
3. Configure your domain and use nginx to serve your static files
...
<CodeBlock
  ...
  code={`server {
    ...
    location ~* \.(png|jpg|jpeg|gif|svg|ico|js|css|woff|woff2|ttf|eot)$ {
        try_files $uri =404;
        expires 1y;
...
<details>
  <summary>How can add SEO to my slides?</summary>
  Sli.dev has you covered, [SEO Meta Tags](https://sli.dev/features/seo-meta)
